...
parser.add_argument("--dtype", type=str, default="float32", help="training data type (default: float32)")
...
def evaluate_ce(model, data_iter, context):
    data_iter.reset()
...
for epoch in range(args.epochs):
    ...
    for nbatch, batch in enumerate(train_data, start=1):
        ...
        if nbatch % 100 == 0:
            ...
            logging.info("[Epoch %d Batch %d] Speed=%.2f samples/s", epoch, nbatch, speed)
    ...
    name, val_ce = evaluate_ce(model, val_data, context)
